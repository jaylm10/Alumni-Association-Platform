        ...
        <div className="footer-container">
          <div className="footer-primary">
            <div className="footer-brand">
              ...
              <p>Bridging the gap between students and alumni to create meaningful professional connections.</p>
            ...
            <div className="footer-links-section">
              <div className="footer-links">
                ...
                <ul>
                  ...
                  <li><a href="/jobs">Jobs & Internships</a></li>
                </ul>
              </div>
              ...
              <div className="footer-contact">
                ...
                <ul>
                  <li className="contact-item">
                    ...
                    <span>123 University Avenue<br />Campus Building, Room 456<br />City, State 12345</span>
                  </li>
                  <li className="contact-item">
